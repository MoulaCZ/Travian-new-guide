import {
  ...
  Flag, Coins, Lightbulb, X, ChevronRight, Rocket, MessageSquarePlus, Target, Calculator, LineChart,
} from 'lucide-react'

const iconMap = { BookOpen, MapPin, Shield, Wheat, Swords, Flag, Coins, Lightbulb, Target, Calculator, LineChart }
