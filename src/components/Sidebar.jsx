import {
  ...
  Flag, Coins, Lightbulb, X, ChevronRight, Rocket, MessageSquarePlus, Target, LineChart, Route,
} from 'lucide-react'

const iconMap = { BookOpen, MapPin, Shield, Wheat, Swords, Flag, Coins, Lightbulb, Target, LineChart, Route }
