...
export default function SuggestEdit({ currentPage }) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-40 flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#21262d] border border-[#30363d] hover:border-amber-500/50 hover:bg-[#30363d] text-gray-300 hover:text-amber-400 shadow-xl transition-all duration-200 text-sm font-medium group"
